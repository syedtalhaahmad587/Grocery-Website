...
const Navbar = (props) => {
  ...
  return (
    <>
      <div className={navbar  ? `main_navbar ${props.className} sticky  `  : `main_navbar ${props.className}`  }>
